...
public class DemoScript : MonoBehaviour
{
    ...
    private void InitializeOutputDevice()
    {
        ...
        var nonDefaultPiano = OutputDevice.GetAll().First(d => d.Name != OutputDeviceName);
        ...
        _outputDevice = nonDefaultPiano;
        Debug.Log($"Output device [{_outputDevice.Name}] initialized.");
    }
